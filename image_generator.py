...
if __name__=='__main__':
    ...
    for idx, fname in enumerate(images):
        ...
        #out_img[nonzeroy[left_lane_idx], nonzerox[left_lane_idx]] = [0, 0, 255]
        #out_img[nonzeroy[right_lane_idx], nonzerox[right_lane_idx]] = [255, 0, 0]
        ...
        write_name = './test_images/unwarped_lane'+str(idx+1)+'.jpg'
